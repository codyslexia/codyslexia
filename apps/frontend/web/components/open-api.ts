...
export namespace OpenAPI {
  ...
  // }>
  export type Document<T extends object = object> =
    | OpenAPIV2.Document<T>
    | OpenAPIV3.Document<T>
    | OpenAPIV3_1.Document<T>
  export type Operation<T extends object = object> =
...
export namespace OpenAPIV3_1 {
  ...
  export type PathsObject<T extends object = object, P extends object = object> = Record<
    string,
...
export namespace OpenAPIV3 {
  ...
  export interface PathsObject<T extends object = object, P extends object = object> {
...
export namespace OpenAPIV2 {
  ...
  export interface PathsObject<T extends object = object> {
