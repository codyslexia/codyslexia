...
import { isFunction, isPlainObject, isString, isUndefined } from '../utils/predicates'
...
export class ConsoleLogger implements LoggerService {
  ...
  protected printMessages(
    ...
    messages.forEach((message) => {
      ...
      const formattedMessage = this.formatMessage(logLevel, message, pidMessage, formattedLogLevel)
  ...
  protected formatPid(pid: number) {
    return `[${this.options?.appName ?? 'logger'}] ${pid} - `
  }
