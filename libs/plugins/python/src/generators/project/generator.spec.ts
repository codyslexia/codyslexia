...
describe('@plugins/python project generator', () => {
  ...
  it('should generate a python project using description option', async () => {
    ...
    expect(appTree.read('apps/test/pyproject.toml').toString()).toMatchSnapshot()
  })
...
function assertGenerateFiles(appTree: Tree, projectDirectory: string, moduleName: string) {
  expect(appTree.exists(`${projectDirectory}/tox.ini`)).toBeTruthy()
  expect(appTree.read(`${projectDirectory}/tox.ini`).toString()).toMatchSnapshot()
  expect(appTree.exists(`${projectDirectory}/README.md`)).toBeTruthy()
  expect(appTree.read(`${projectDirectory}/README.md`).toString()).toMatchSnapshot()
  expect(appTree.exists(`${projectDirectory}/pyproject.toml`)).toBeTruthy()
  expect(appTree.read(`${projectDirectory}/pyproject.toml`).toString()).toMatchSnapshot()
  expect(appTree.exists(`${projectDirectory}/CHANGELOG.md`)).toBeTruthy()
  expect(appTree.read(`${projectDirectory}/CHANGELOG.md`).toString()).toMatchSnapshot()
  expect(appTree.exists(`${projectDirectory}/.flake8`)).toBeTruthy()
  expect(appTree.read(`${projectDirectory}/.flake8`).toString()).toMatchSnapshot()
  expect(appTree.exists(`${projectDirectory}/${moduleName}/index.py`)).toBeTruthy()
  expect(appTree.read(`${projectDirectory}/${moduleName}/index.py`).toString()).toMatchSnapshot()
  expect(appTree.exists(`${projectDirectory}/tests/test_index.py`)).toBeTruthy()
  expect(appTree.read(`${projectDirectory}/tests/test_index.py`).toString()).toMatchSnapshot()
  expect(appTree.read(`${projectDirectory}/.python-version`).toString()).toMatchSnapshot()
}
