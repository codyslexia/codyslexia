 ...
 */
const extractProjectRootMap = (context: CreateDependenciesContext): ProjectRootMap =>
 ...
 */
const getFileModuleImports = (fileData: FileData, modules: GoModule[]): GoImportWithModule[] => {
...
const getProjectNameForGoImport = (
  ...
  const relativeModuleDir = module.Dir.substring(workspaceRoot.length + 1).replace(/\\/g, '/')
